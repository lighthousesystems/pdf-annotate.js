...
See [StoreAdapter.getAnnotations()](https://github.com/lighthousesystems/pdf-annotate.js/blob/master/docs/api/StoreAdapter.md#getannotations).
...
See [StoreAdapter](https://github.com/lighthousesystems/pdf-annotate.js/blob/master/docs/api/StoreAdapter.md).
...
See [UI](https://github.com/lighthousesystems/pdf-annotate.js/blob/master/docs/api/UI.md).
